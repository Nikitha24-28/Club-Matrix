...
import {
  Home, Users, Calendar, Settings, TrendingUp, Plus,
        ...
        <nav className="sidebar-nav">
          <div className="nav-items">
            {[
              ...
              { icon: <Users size={20} />, label: "Public Clubs" },
      ...
      <div className="main-content">
        ...
        <main className="clubs-grid">
          {[
            ...
            { name: "Startup Hub", members: 312, category: "green" },
            { name: "Photography Club", members: 89, category: "orange" },
            { name: "Music Collective", members: 203, category: "indigo" },
            { name: "Sports League", members: 445, category: "teal" }
          ].map((club, index) => (
